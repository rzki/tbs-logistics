                                ...
                                <div class="container-fluid px-3">
                                    <div class="row mb-3">
                                        <div class="col d-flex justify-content-end pb-3">
                                            <a href="{{ route('roles.create') }}" class="btn btn-success ml-3 text-white" wire:navigate><i class="fa fa-plus" aria-hidden="true"></i>{{ __(' Create New Role') }}</a>
                                        </div>
                                    </div>
                                                ...
                                                @foreach ($roles as $role)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-danger" wire:click.prevent="deleteConfirm('{{ $role->id }}')"><i class="fas fa-trash"></i></button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
