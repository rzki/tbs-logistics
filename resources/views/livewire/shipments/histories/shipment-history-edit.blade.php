            ...
            <div class="col-12 col-xl-12">
                <div class="col-12 px-0">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            <h2 class="fs-5 fw-bold mb-5">{{ __('Update Shipment History') }}</h2>
                            <div class="row mb-5">
                                <div class="col">
                                    <a href="{{ route('shipment.histories.index', $shipment->shipmentId) }}"
                                        class="btn btn-primary text-white" wire:navigate><i
