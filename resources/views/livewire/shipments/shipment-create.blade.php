            ...
            <div class="col-12 col-xl-12">
                <div class="col-12 px-0">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            <h2 class="fs-5 fw-bold mb-5">{{ __('Create New Shipment') }}</h2>
                            <div class="row mb-5">
                                <div class="col">
                                ...
                                <div class="col">
                                    <form wire:submit='create'>
                                        ...
                                        <div class="row">
                                            ...
                                            {{-- <div class="form-group mb-3">
                                                <label for="shipment_status" class="form-label">{{ __('Status') }}</label>
                                                <select name="shipment_status" id="shipment_status" class="form-control" wire:model='shipment_status'>
